...
require_once('KingdomBuilderPlayer.class.php');

class KingdomBuilderPlayerManager extends APP_GameClass
{
  public $game;
  ...
  public function setupNewGame($players)
  {
    ...
    $this->game->reattributeColorsBasedOnPreferences($players, [ "ff0000", "008000", "0000ff", "ffa500", "ffffff", "e94190", "982fff", "72c3b1", "f07f16", "bdd002", "7b7b7b" ]);
  ...
  public function getPlayers($playerIds = null)
  {
    ...
    $players = [];
    foreach ($rows as $row) {
      $player = new KingdomBuilderPlayer($this->game, $row);
      $players[] = $player;
    }
    return $players;
  }
